...
function VolumeSlider() {
  const { volume, setVolume, notif, setNotif } = useAudio();
  ...
  return (
    <div className="VolumeSlider">
      <img
        src={
          notif
            ...
            : "https://api.iconify.design/material-symbols:notifications-off-rounded.svg"
        }
        alt=""
      ...
      <img
        src={
          bgmAudioRef.current?.muted
            ? "https://api.iconify.design/fluent:music-note-off-2-20-filled.svg"
            : "https://api.iconify.design/ion:musical-notes.svg"
        }
        alt=""
        className="BGMIcon"
      />
